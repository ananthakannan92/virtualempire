...
find ${DISTNAME}/bin -type f -executable -exec ../virtualempirecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../virtualempirecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/virtualempirecoin/temp
cd ~/virtualempirecoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/virtualempirecoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/virtualempirecoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
