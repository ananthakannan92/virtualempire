...
#ifndef VIRTUALEMPIRE_QT_OPTIONSMODEL_H
#define VIRTUALEMPIRE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for virtualempire client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // VirtualempireUnits::Unit
...
#endif // VIRTUALEMPIRE_QT_OPTIONSMODEL_H
