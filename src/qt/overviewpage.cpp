...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(VirtualempireUnits::VTE),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->virtualempireBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->virtualempireBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(VirtualempireUnits::formatWithUnit(unit, balance, false, VirtualempireUnits::separatorAlways));
    ui->labelUnconfirmed->setText(VirtualempireUnits::formatWithUnit(unit, unconfirmedBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelImmature->setText(VirtualempireUnits::formatWithUnit(unit, immatureBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelTotal->setText(VirtualempireUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelWatchAvailable->setText(VirtualempireUnits::formatWithUnit(unit, watchOnlyBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelWatchPending->setText(VirtualempireUnits::formatWithUnit(unit, watchUnconfBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelWatchImmature->setText(VirtualempireUnits::formatWithUnit(unit, watchImmatureBalance, false, VirtualempireUnits::separatorAlways));
    ui->labelWatchTotal->setText(VirtualempireUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, VirtualempireUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("VTE")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the VTE balance grid from expanding and looking terrible when asset balance is hidden
