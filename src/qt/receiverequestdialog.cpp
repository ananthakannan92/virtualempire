...
#include "config/virtualempire-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVirtualempireURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VirtualempireUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVirtualempireURI(info));
}
