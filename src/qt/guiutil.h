...
#ifndef VIRTUALEMPIRE_QT_GUIUTIL_H
#define VIRTUALEMPIRE_QT_GUIUTIL_H
...
/** Utility functions used by the virtualempire Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "virtualempire:" URI into recipient object, return true on successful parsing
...
#endif // VIRTUALEMPIRE_QT_GUIUTIL_H
