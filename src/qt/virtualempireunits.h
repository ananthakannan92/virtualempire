...
#ifndef VIRTUALEMPIRE_QT_VIRTUALEMPIREUNITS_H
#define VIRTUALEMPIRE_QT_VIRTUALEMPIREUNITS_H
...
/** virtualempire unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VirtualempireUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VirtualempireUnits(QObject *parent);
...
typedef VirtualempireUnits::Unit VirtualempireUnit;

#endif // VIRTUALEMPIRE_QT_VIRTUALEMPIREUNITS_H
