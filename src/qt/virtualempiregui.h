...
#ifndef VIRTUALEMPIRE_QT_VirtualempireGUI_H
#define VIRTUALEMPIRE_QT_VirtualempireGUI_H
...
/**
  virtualempire GUI main class. This class represents the main window of the virtualempire UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VirtualempireGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VirtualempireGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~VirtualempireGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a virtualempire wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // VIRTUALEMPIRE_QT_VirtualempireGUI_H
