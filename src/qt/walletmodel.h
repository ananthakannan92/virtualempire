...
#ifndef VIRTUALEMPIRE_QT_WALLETMODEL_H
#define VIRTUALEMPIRE_QT_WALLETMODEL_H
...
/** Interface to virtualempire wallet from Qt view code. */
...
#endif // VIRTUALEMPIRE_QT_WALLETMODEL_H
