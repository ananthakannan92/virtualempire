...
#include "qt/virtualempireamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<VirtualempireAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_virtualempire-qt -platform xcb      # Linux
//     src/qt/test/test_virtualempire-qt -platform windows  # Windows
//     src/qt/test/test_virtualempire-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = VirtualempireUnits::formatWithUnit(unit, balance, false, VirtualempireUnits::separatorAlways);
    ...
    // Amount input
    VirtualempireAmountField* amountInput = receiveCoinsDialog.findChild<VirtualempireAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: virtualempire:")) != -1);
