...
#ifndef VIRTUALEMPIRE_QT_WALLETVIEW_H
#define VIRTUALEMPIRE_QT_WALLETVIEW_H
...
public:
    ...
    void setVirtualempireGUI(VirtualempireGUI *gui);
...
#endif // VIRTUALEMPIRE_QT_WALLETVIEW_H
