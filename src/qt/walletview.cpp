...
void WalletView::setVirtualempireGUI(VirtualempireGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? VirtualempireGUI::HD44_ENABLED : _walletModel->hdEnabled() ? VirtualempireGUI::HD_ENABLED : VirtualempireGUI::HD_DISABLED);
