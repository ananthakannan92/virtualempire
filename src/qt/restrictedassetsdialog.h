...
#ifndef VIRTUALEMPIRE_QT_RESTRICTEDASSETSDIALOG_H
#define VIRTUALEMPIRE_QT_RESTRICTEDASSETSDIALOG_H
...
/** Dialog for sending virtualempire */
...
#endif // VIRTUALEMPIRE_QT_RESTRICTEDASSETSSDIALOG_H
