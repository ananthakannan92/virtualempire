...
#ifndef VIRTUALEMPIRE_QT_SENDASSETSENTRY_H
#define VIRTUALEMPIRE_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending virtualempire.
...
#endif // VIRTUALEMPIRE_QT_SENDASSETSENTRY_H
