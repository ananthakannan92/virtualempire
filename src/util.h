 ...
 */
#ifndef VIRTUALEMPIRE_UTIL_H
#define VIRTUALEMPIRE_UTIL_H
...
extern const char *const VIRTUALEMPIRE_CONF_FILENAME;
extern const char *const VIRTUALEMPIRE_PID_FILENAME;
...
{
    std::string s = strprintf("virtualempire-%s", name);
