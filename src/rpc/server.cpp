...
CAmount AmountFromValue(const UniValue& value, bool p_isVTE)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Virtualempire server stopping";
}
...
{
    return "> virtualempire-cli " + methodname + " " + args + "\n";
}
