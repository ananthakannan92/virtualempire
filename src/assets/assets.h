...
#ifndef VIRTUALEMPIRECOIN_ASSET_PROTOCOL_H
#define VIRTUALEMPIRECOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_VIRTUALEMPIRE_ASSET VTEQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_VIRTUALEMPIRE_ASSET VTEO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_VIRTUALEMPIRE_ASSET VTER
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_VIRTUALEMPIRE_ASSET VTET
...
#endif //VIRTUALEMPIRECOIN_ASSET_PROTOCOL_H
