...
#ifndef VIRTUALEMPIRE_VALIDATION_H
#define VIRTUALEMPIRE_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for virtualempire, with 1 minutes block intervals?
...
#endif // VIRTUALEMPIRE_VALIDATION_H
