...
#ifndef VIRTUALEMPIRE_SCRIPT_STANDARD_H
#define VIRTUALEMPIRE_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_VIRTUALEMPIRE_ASSET script that carries data
    /** VIRTUALEMPIRE END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a virtualempire address
 */
...
/**
 * Generate a Virtualempire scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // VIRTUALEMPIRE_SCRIPT_STANDARD_H
