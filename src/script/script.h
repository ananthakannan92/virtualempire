...
#ifndef VIRTUALEMPIRE_SCRIPT_SCRIPT_H
#define VIRTUALEMPIRE_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Virtualempire always counted CHECKMULTISIGs
...
#endif // VIRTUALEMPIRE_SCRIPT_SCRIPT_H
