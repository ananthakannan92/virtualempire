...
#ifndef VIRTUALEMPIRE_CHAINPARAMS_H
#define VIRTUALEMPIRE_CHAINPARAMS_H
 ...
 * Virtualempire system. There are three: the main network on which people trade goods
...
#endif // VIRTUALEMPIRE_CHAINPARAMS_H
