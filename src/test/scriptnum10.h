...
#ifndef VIRTUALEMPIRE_TEST_SCRIPTNUM10_H
#define VIRTUALEMPIRE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Virtualempire Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VIRTUALEMPIRE_TEST_BIGNUM_H
