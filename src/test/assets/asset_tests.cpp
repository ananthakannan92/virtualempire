...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        //- Versions of VIRTUALEMPIRE NOT allowed
        BOOST_CHECK(!IsAssetNameValid("RVN", type));
        BOOST_CHECK(!IsAssetNameValid("RAVEN", type));
        BOOST_CHECK(!IsAssetNameValid("RAVENCOIN", type));
        BOOST_CHECK(!IsAssetNameValid("VTE", type));
        BOOST_CHECK(!IsAssetNameValid("VIRTUALEMPIRE", type));

        //- Versions of VIRTUALEMPIRE ALLOWED
        BOOST_CHECK(IsAssetNameValid("RAVEN.COIN", type));
        BOOST_CHECK(IsAssetNameValid("VIRTUALEMPIRE.COIN", type));
        BOOST_CHECK(IsAssetNameValid("RAVEN_COIN", type));
        BOOST_CHECK(IsAssetNameValid("VIRTUALEMPIRE_COIN", type));
        ...
        BOOST_CHECK(IsAssetNameValid("BLACK_VIRTUALEMPIRE", type));
