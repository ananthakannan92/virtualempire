...
#ifndef VIRTUALEMPIRE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define VIRTUALEMPIRE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // VIRTUALEMPIRE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
