...
"""
    ...
    Virtualempire should be started with the command line arguments:
        virtualempired -testnet -daemon \
...
print("Getting Virtualempire msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND VTE issuance at " + str(pos))
				print("After VTE: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND VTE something at " + str(pos))
			start += pos+8
			print(astr)
