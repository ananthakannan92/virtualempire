...
import os
import struct
from test_framework.test_framework import VirtualempireTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(VirtualempireTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that virtualempire has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("virtualempired has not been built with zmq enabled.")
