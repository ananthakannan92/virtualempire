...
class WalletTest(VirtualempireTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 VTE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 VTE with subtract fee from amount
        ...
        # Sendmany 10 VTE with subtract fee from amount
