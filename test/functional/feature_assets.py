...
class AssetTest(VirtualempireTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("VIRTUALEMPIRE1", 1000)
        n0.issue("VIRTUALEMPIRE2", 1000)
        n0.issue("VIRTUALEMPIRE3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="VIRTUALEMPIRE*", verbose=False, count=2, start=-2)
        ...
        virtualempire_assets = n0.listassets(asset="VIRTUALEMPIRE*", verbose=False, count=2, start=-2)
        assert_equal(len(virtualempire_assets), 2)
        assert_equal(virtualempire_assets[0], "VIRTUALEMPIRE2")
        assert_equal(virtualempire_assets[1], "VIRTUALEMPIRE3")
        self.sync_all()
