...
class BIP66Test(VirtualempireTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # virtualempired is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and virtualempired produces more specific reject
            # reasons.
