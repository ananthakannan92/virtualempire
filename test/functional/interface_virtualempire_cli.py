...
class TestVirtualempireCli(VirtualempireTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `virtualempire-cli getinfo`")
        ...
        self.log.info("Compare responses from `virtualempire-cli -getinfo` and the RPCs data is retrieved from.")
