...
# TestNode: A peer we use to send messages to virtualempired, and store responses.
...
class CompactBlocksTest(VirtualempireTestFramework):
    ...
    # This test actually causes virtualempired to (reasonably!) disconnect us, so do this last.
    ...
    # virtualempired's choice of nonce.
    ...
    # Test that virtualempired requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for virtualempired to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # virtualempired will not send blocktxn responses for blocks whose height is
