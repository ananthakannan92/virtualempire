...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VirtualempireTestFramework
    pass

class ExampleTest(VirtualempireTestFramework):
    # Each functional test is a subclass of the VirtualempireTestFramework class.
    ...
    def custom_method(self):
        ...
        VirtualempireTestFramework class so other tests can use it."""
