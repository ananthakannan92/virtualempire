...
class TxnMallTest(VirtualempireTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 VTE:
        ...
        # First: use raw transaction API to send 1240 VTE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VTE coin each
        ...
        # Node0's balance should be starting balance, plus 50VTE for another
        ...
        # Node0's total balance should be starting balance, plus 100VTE for 
