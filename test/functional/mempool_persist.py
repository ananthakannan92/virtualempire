...
By default, virtualempired will dump mempool on shutdown and
...
class MempoolPersistTest(VirtualempireTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give virtualempired a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent virtualempired from writing mempool.dat to disk. Verify that `savemempool` fails")
